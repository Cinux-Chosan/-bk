...
define('amazon/tests/app.lint-test', [], function () {
  ...
  QUnit.test('app.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'app.js should pass ESLint\n\n32:5 - \'isLocalFile\' is assigned a value but never used. (no-unused-vars)\n35:24 - \'myLocalStorage\' is not defined. (no-undef)');
  });
  ...
  QUnit.test('pod/survey/survey-comp/component.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'pod/survey/survey-comp/component.js should pass ESLint\n\n1:8 - \'$\' is defined but never used. (no-unused-vars)\n114:5 - Unexpected \'debugger\' statement. (no-debugger)');
  });
